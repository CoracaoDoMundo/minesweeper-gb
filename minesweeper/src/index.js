...
const gameField = new Field(ghostInput, isSoundsOn, isMusicOn, isPause, themeToggle);
...
themeToggle.render(settingsBlock.item, 'theme', 'light', 'toggleLight', 'toggleDark', gameField);
